...
- [`ovos-memory-plugin-lexical`](./lexical.md): SQLite FTS5 keyword recall (zero dependencies).
- [`ovos-memory-plugin-recency`](./recency.md): sliding short-term buffer (zero dependencies).
